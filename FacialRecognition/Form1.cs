...
new Size(20, 20));
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            per.Dni = textBox1.Text;
            per.xImagen = Application.StartupPath + "/TrainedFaces/face" + (trainingImages.ToArray().Length) + ".bmp";
            obj.RN_Editar_Foto(per);
