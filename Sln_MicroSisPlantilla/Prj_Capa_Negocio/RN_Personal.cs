...
namespace Prj_Capa_Negocio
{
    public class RN_Personal
    {
        ...
        public void RN_Editar_Foto(EN_Persona per)
        {
            BD_Personal obj = new BD_Personal();
            obj.BD_Editar_Foto(per);
        }
        public void RN_Registrar_Huella_Personal(string idper, object finger)
        {
            BD_Personal obj = new BD_Personal();
            obj.BD_Registrar_Huella_Personal(idper, finger);
        }
        public DataTable RN_Leer_todoPersona()
        {
            BD_Personal obj = new BD_Personal();
            return obj.BD_Leer_todoPerson();
        }
