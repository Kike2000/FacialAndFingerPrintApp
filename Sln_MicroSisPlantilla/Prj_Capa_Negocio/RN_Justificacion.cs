...
namespace Prj_Capa_Negocio
{
    ...
    {
        public void RN_Registrar_Justificacin(EN_Justificacion jus)
        {
            BD_Justificacion obj = new BD_Justificacion();
            obj.BD_Registrar_Justificacin(jus);
        }
        ...
        public void RN_Aprobar_Justificacion(string id_justi, string idperso)
        {
            BD_Justificacion obj = new BD_Justificacion();
            obj.BD_Aprobar_Justificacion(id_justi, idperso);
        }
