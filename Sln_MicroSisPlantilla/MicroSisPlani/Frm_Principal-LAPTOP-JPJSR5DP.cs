...
namespace MicroSisPlani
{
    public partial class Frm_Principal : Form
    {
        ...
        private void Frm_Principal_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (Close == true && Convert.ToString(sino.Tag) == "Si")
            {
        ...
        private void ConfiguraListView_Justi()
        {
            ...
            lis.Columns.Add("Detalle Justifica", 0, HorizontalAlignment.Left);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                smtp.Credentials = new System.Net.NetworkCredential("ilomogto@outlook.es", "81820002230382Pedro");
                smtp.EnableSsl = true;
                smtp.Timeout = 10000;
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            using (SaveFileDialog sfd = new SaveFileDialog() { Filter = "Excel Workbook|* .xls", ValidateNames = true })
            {
                if (sfd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    Microsoft.Office.Interop.Excel.Worksheet ws = (Microsoft.Office.Interop.Excel.Worksheet)app.ActiveSheet;
                    app.Visible = false;
                    ws.Cells[1, 1] = "Nombre del personal";
                    ws.Cells[1, 2] = "Motivo";
                    ws.Cells[1, 3] = "Fecha Emisión";
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            using (SaveFileDialog sfd = new SaveFileDialog() { Filter = "Excel Workbook|* .xls", ValidateNames = true })
            {
                if (sfd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    app.Visible = false;
                    ws.Cells[1, 1] = "Código";
                    ws.Cells[1, 2] = "Nombres";
                    ws.Cells[1, 3] = "Fecha Nacimiento";
                    ws.Cells[1, 4] = "No. Celular";
                    ws.Cells[1, 5] = "Cargo";
                    ws.Cells[1, 6] = "Estado";
                    int i = 2;
